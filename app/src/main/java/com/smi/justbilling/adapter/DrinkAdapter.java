...
public class DrinkAdapter extends RecyclerView.Adapter<DrinkAdapter.ImageViewHolder> implements View.OnClickListener,
        View.OnLongClickListener   {

    private Context mContext;
    private List<Uttam> mUpload;
    private OnItemClickListenerDrink mListener;
    private OnItemLongClickListener mLongListener;



    public DrinkAdapter(Context context, List<Uttam> upload) {
        mContext = context;
        mUpload = upload;
    }
        ...
        public void onClick(View v) {
            ...
            if (mListener != null) {
                ...
                if (position != RecyclerView.NO_POSITION) {
                    mListener.onItemClickDrink(position);
                }
            }
    ...
    public interface OnItemClickListenerDrink {
        void onItemClickDrink(int position);
    ...
    public void setOnItemClickListener(OnItemClickListenerDrink listener) {
