...
public class RiceAdapter extends RecyclerView.Adapter<RiceAdapter.ImageViewHolder> implements View.OnClickListener,
        View.OnLongClickListener   {

    private Context mContext;
    private List<Uttam> mUpload;
    private OnItemClickListenerRice mListener;
    private OnItemLongClickListener mLongListener;



    public RiceAdapter(Context context, List<Uttam> upload) {
        mContext = context;
        mUpload = upload;
    }
        ...
        public void onClick(View v) {
            ...
            if (mListener != null) {
                ...
                if (position != RecyclerView.NO_POSITION) {
                    mListener.onItemClickRice(position);
                }
            }
    ...
    public interface OnItemClickListenerRice {
        void onItemClickRice(int position);
    ...
    public void setOnItemClickListener(OnItemClickListenerRice listener) {
