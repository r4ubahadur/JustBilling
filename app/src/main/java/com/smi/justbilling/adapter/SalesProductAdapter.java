...
public class SalesProductAdapter extends RecyclerView.Adapter<SalesProductAdapter.ImageViewHolder> implements View.OnClickListener,
    ...
    public SalesProductAdapter(Context context, List<Uttam> upload) {
        mContext = context;
        mUpload = upload;
    }
