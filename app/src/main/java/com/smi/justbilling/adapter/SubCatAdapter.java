...
public class SubCatAdapter extends RecyclerView.Adapter<SubCatAdapter.ImageViewHolder> implements View.OnClickListener,
    ...
    public SubCatAdapter(Context context, List<Uttam> upload) {
        mContext = context;
        mUpload = upload;
    }
    ...
    public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.abc_sub_cat_single_item, parent, false);
